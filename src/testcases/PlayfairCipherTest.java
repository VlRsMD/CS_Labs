...
public class PlayfairCipherTest {
    public static void main(String[] args) {
        ...
        System.out.println("The ciphertext for the plaintext Nr. 1 is: " + playfairCipher.encrypt(plaintext, keystreamE) + "\n");
        System.out.println("The plaintext for the ciphertext Nr. 2 is: " + playfairCipher.decrypt(ciphertext, keystreamD));
    }
}
